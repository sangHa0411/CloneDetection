...
def main():
    ...
    random_numbers_train = np.random.randint(0, 6928341, int(500000)) # can be set as a parameter if K-Fold is used
    random_numbers_val = np.random.randint(0, 6928341, int(50000)) # can be set as a parameter if K-Fold is used
